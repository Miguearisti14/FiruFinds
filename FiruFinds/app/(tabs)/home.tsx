...
// Componente para la pestaña "Perdidos" (Placeholder por ahora)

const LostPetsScreen = () => (
    <View style={styles.placeholderContainer}>
        <Text style={styles.placeholderText}>No hay datos para Perdidos. Agrega una tabla o filtro si es necesario.</Text>
    </View>
